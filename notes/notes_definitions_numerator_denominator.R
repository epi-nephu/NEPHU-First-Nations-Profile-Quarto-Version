...
note_denominator_census_lga <- glue::glue("
Total number of people with a residential address in the geographical area (e.g. SA2, LGA, LPHU catchment, Victoria) in the 2021 Census.")
