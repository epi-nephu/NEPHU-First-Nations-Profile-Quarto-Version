...
- Organisations that release publicly available data employ techniques to manage the risk of reidentification of individuals included in these datasets. For tables and figures where small numbers are reported, these small numbers should be interpreted with caution. Commonly used techniques for masking of small numbers include:
